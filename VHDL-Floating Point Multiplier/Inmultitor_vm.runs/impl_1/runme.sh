...
HD_PWD='C:/Users/Rafael/Desktop/SSC_trec/Inmultitor_somehow/Inmultitor_somehow.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPU.tcl -notrace
