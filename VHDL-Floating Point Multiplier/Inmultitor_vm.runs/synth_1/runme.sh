...
HD_PWD='C:/Users/Rafael/Desktop/SSC_trec/Inmultitor_somehow/Inmultitor_somehow.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPU.tcl
